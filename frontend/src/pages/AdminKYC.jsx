...
const AdminKYC = () => {
  ...
  const fetchKycRequests = async () => {
    try {
      ...
      const res = await fetch(`${API_URL}/kyc/all?status=${filterStatus}${adminParam}`, {
  ...
  return (
    <AdminLayout title="KYC Verification" subtitle="Verify user identity documents" requiredPermission="canManageKYC">
      {/* Stats */}
