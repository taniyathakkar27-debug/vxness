...
//               <button className="px-6 py-2 rounded-lg border border-gray-700 hover:border-cyan-500 transition-colors font-medium">
//                 Log In
//               </button>
//               <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 transition-all font-medium shadow-lg shadow-cyan-500/20">
//                 Sign Up
//               </button>
//             </div>
...
//                       setIsMenuOpen(false);
//                     }}
//                     className="w-full py-2 rounded-lg border border-gray-700 hover:border-cyan-500 transition-colors"
//                   >
//                     Log In
//                   </button>
//                   <button className="w-full py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600">
//                     Sign Up
//                   </button>
//                 </div>
//               </div>
...
//                 <button className="px-8 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 transition-all font-medium flex items-center justify-center space-x-2 shadow-lg shadow-cyan-500/20">
//                   <span>Start Trading Now</span>
//                   <FiChevronRight className="text-xl" />
//                 </button>
//                 <button className="px-8 py-3 rounded-lg border border-gray-700 hover:border-cyan-500 hover:text-cyan-400 transition-colors font-medium">
//                   View Demo
//                 </button>
//               </div>

//               <div className="flex flex-col sm:flex-row gap-4">
//                 <button className="px-6 py-3 rounded-lg bg-gray-800/50 border border-gray-700 hover:border-cyan-500 transition-colors flex items-center justify-center space-x-2">
//                   <FaGooglePlay />
...
//             <button className="px-8 py-3 rounded-lg border border-gray-700 hover:border-cyan-500 hover:text-cyan-400 transition-colors font-medium inline-flex items-center space-x-2">
...
//               <button className="px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 transition-all font-medium text-lg flex items-center justify-center space-x-2 shadow-lg shadow-cyan-500/20">
              ...
              <div className="flex flex-col space-y-4">
                <button
                  ...
                  className={`font-medium py-2 text-left ${
                    activeSection === "home" ? "text-cyan-400" : "text-white"
                  }`}
                >
                  Home
                </button>
                ...
                <button
                  onClick={() => scrollToSection("markets")}
                  className={`font-medium py-2 text-left ${
                    activeSection === "markets" ? "text-cyan-400" : "text-white"
                  }`}
                >
                  Markets
                </button>
                ...
                <button
                  onClick={() => scrollToSection("faq")}
                  className={`font-medium py-2 text-left ${
                    activeSection === "faq" ? "text-cyan-400" : "text-white"
                  }`}
                >
                  FAQ
                </button>
                <div className="flex flex-col space-y-2 pt-4 border-t border-gray-800">
                  ...
                  <button
                    onClick={handleSignUp}
                    className="w-full py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 transition-all"
                  >
                    Sign Up
                  </button>
                </div>
